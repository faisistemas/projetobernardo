...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-hero text-white">
      ...
      <div className="container-section relative z-10 py-10 md:py-10 grid lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="hidden lg:block animate-fade-in mt-10">
